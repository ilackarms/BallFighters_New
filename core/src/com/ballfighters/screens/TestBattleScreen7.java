...
import com.ballfighters.game.world.BallWorld7;
 ...
 */
public class TestBattleScreen7 extends GameScreen {

    private BallWorld7 ballWorld;
    ...
    public void show(){
        ...
        ballWorld = new BallWorld7(batch);
    ...
    public void startMusic() {
        GameData.playMusic("Music/BadBossBoogieDKC.mp3");
//        track = MathUtils.random(0, 5);
//        switch (track % 5) {
//            case 5:
