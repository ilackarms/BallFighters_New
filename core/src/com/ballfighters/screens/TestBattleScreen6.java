 ...
 */
public class TestBattleScreen6 extends GameScreen {

    private BallWorld6 ballWorld;
    ...
    public void show(){
        ...
        ballWorld = new BallWorld6(batch);
    ...
    public void startMusic() {
        GameData.playMusic("Music/Megaman7Stage2.mp3");
//        track = MathUtils.random(0, 5);
//        switch (track % 5) {
//            case 5:
