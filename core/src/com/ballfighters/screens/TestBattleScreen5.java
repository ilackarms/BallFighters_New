 ...
 */
public class TestBattleScreen5 extends GameScreen {

    private BallWorld5 ballWorld;
    ...
    public void show(){
        ...
        ballWorld = new BallWorld5(batch);
    ...
    public void startMusic() {
        GameData.playMusic("Music/Megaman7Stage1.mp3");
//        track = MathUtils.random(0, 5);
//        switch (track % 5) {
//            case 5:
