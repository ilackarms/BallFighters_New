 ...
 */
public class PlantGuyProjectile extends Bullet {

    public PlantGuyProjectile(GameBody parent, Vector2 position, Vector2 velocity) {
        ...
        animator = new Animator("Sprites/PlantGuyProjectile.png", 1, 6, 0.125f);
