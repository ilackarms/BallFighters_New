 ...
 */
public class BombGuyProjectile extends Bullet {


    public BombGuyProjectile(GameBody parent, Vector2 position, Vector2 velocity) {
        ...
        animator = new Animator("Sprites/BombGuyProjectile.png", 1, 3, 0.125f);
