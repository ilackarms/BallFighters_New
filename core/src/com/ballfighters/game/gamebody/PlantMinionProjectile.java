 ...
 */
public class PlantMinionProjectile extends Bullet {

    PlantMinionProjectile self;
    float radius;
    Vector2 constantVelocity;

    public PlantMinionProjectile(GameBody parent, Vector2 position, final Vector2 velocity) {
        ...
        animator = new Animator("Sprites/PlantMinionProjectile.png", 1, 4, 0.25f);
