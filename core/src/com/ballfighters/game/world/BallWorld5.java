...
public class BallWorld5 {
    ...
    public BallWorld5(SpriteBatch batch){
        ...
        player2 = new BombGuyAI(new Vector2(40,-10));
        ...
        GameData.ANIMATEDBG =new Animator("Backgrounds/8bitmilitary.png",3,4,.125f);
