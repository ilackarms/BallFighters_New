...
public class BallWorld10 {
    ...
    public BallWorld10(SpriteBatch batch){
        ...
        player2 = new NerdGuyAI(new Vector2(40,-10));
        ...
        GameData.ANIMATEDBG =new Animator("Backgrounds/8bitfire1.png",2,4,.125f);
