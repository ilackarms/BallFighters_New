...
public class BallWorld9 {
    ...
    public BallWorld9(SpriteBatch batch){
        ...
        player2 = new PlantGuyAI(new Vector2(40,-10));
        ...
        GameData.ANIMATEDBG =new Animator("Backgrounds/8bitforestraining.png",3,4,0.125f);
