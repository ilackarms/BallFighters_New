...
public class BallWorld2 {
    ...
    public BallWorld2(SpriteBatch batch){
        ...
        player2 = new SwordGuyAI(new Vector2(40,-10));
        ...
        GameData.ANIMATEDBG =new Animator("Backgrounds/8bitforest.png",2,4,.125f);
