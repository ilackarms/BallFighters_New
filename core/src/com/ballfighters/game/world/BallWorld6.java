...
public class BallWorld6 {
    ...
    public BallWorld6(SpriteBatch batch){
        ...
        player2 = new PlasmaGuyAI(new Vector2(40,-10));
        ...
        GameData.ANIMATEDBG =new Animator("Backgrounds/8bitlightningstorm.png",4,4,.125f);
